...
const steps = [
 { number: '01', title: '대화에서 시작합니다', en: 'CONSULTATION', text: '생활 방식과 예산, 입주 일정을 듣고 현장을 실측합니다. 구조 변경 범위와 공정별 견적은 함께 검토합니다.', duration: '상담 · 실측 / 1–2주' },
 { number: '02', title: '도면을 공간으로', en: 'DESIGN & 3D', text: '평면 계획과 마감재 샘플, 조명 배치를 검토합니다. 3D 공간에서 동선과 비례를 확인한 뒤 실시설계를 확정합니다.', duration: '설계 · 소재 협의 / 4–6주' },
 { number: '03', title: '디테일을 현실로', en: 'CONSTRUCTION', text: '철거부터 설비, 전기, 목공, 마감 순으로 시공합니다. 현장 담당자가 주간 공정과 변경 사항을 알려드립니다.', duration: '현장 시공 / 8–12주' },
 { number: '04', title: '완성 이후에도', en: 'AFTERCARE', text: '준공 체크리스트에 따라 마감을 검수하고 사용 안내를 드립니다. 입주 후에도 하자를 접수하고 정기 점검을 진행합니다.', duration: '준공 검수 · A/S / 12개월' },
];
export default function Home() {
 ...
 return <main ref={root}>
  ...
  <section id="studio" className="studio section-wrap">
   ...
   <div className="studio-main" data-reveal><h2>좋은 공간은<br />삶을 앞서가지 않습니다.<br /><span>삶에 자연스럽게 스며듭니다.</span></h2><div className="studio-bottom"><p>보여주기 위한 장식을 덜고 매일 닿는 것에 집중합니다.<br />걷는 동선과 손이 닿는 소재, 빛이 머무는 자리를 살핍니다.<br />설계는 당신의 생활을 이해하는 데서 시작합니다.</p><a className="text-link" href="#process">우리의 작업 방식 <span>↗</span></a></div></div>
   <div className="principles" data-reveal><div><span>01</span><h3>생활을 읽는 설계</h3><p>동선과 수납, 가족의 생활 리듬을<br />평면 계획에 담습니다.</p></div><div><span>02</span><h3>오래 남는 소재</h3><p>유행보다 질감과 내구성을 먼저 봅니다.<br />마감은 실물 샘플로 결정합니다.</p></div><div><span>03</span><h3>한 팀의 책임 시공</h3><p>설계와 현장에 같은 기준을 적용합니다.<br />준공 이후에도 관리를 맡습니다.</p></div></div>
  </section>
  ...
  <section className="final-cta" id="contact"><div className="section-wrap" data-reveal><span className="eyebrow">YOUR SPACE, OUR NEXT STORY</span><h2>다음 공간의 이야기는<br /><em>당신에게서 시작됩니다.</em></h2><div className="final-cta-bottom"><p>지금의 공간에서 바꾸고 싶은 점과 바라는 일상을 알려주세요.<br />계획이 아직 구체적이지 않아도 함께 정리해 드립니다.</p><button className="button bronze" onClick={() => setContact(true)}>무료 견적 · 방문 상담 신청 <span>↗</span></button></div></div></section>
